  ...
  <div className="max-w-5xl mx-auto text-center">
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {/* Plan Semanal */}
        <div className="border border-purple-400 dark:border-purple-600 rounded-xl p-6 shadow-md bg-blue-50 dark:bg-gray-800 flex flex-col justify-between">
          <div>
        ...
        {/* Plan Mensual */}
        <div className="border border-purple-400 dark:border-purple-600 rounded-xl p-6 shadow-md bg-purple-100 dark:bg-gray-800 flex flex-col justify-between">
          <div>
          ...
          <Link
            href="https://checkout.stripe.com/pay/tu_link_del_plan_mensual"
            target="_blank"
            className="mt-4 bg-purple-700 hover:bg-purple-800 text-white font-semibold py-2 px-4 rounded-lg transition"
          >
        ...
        {/* Plan Anual */}
        <div className="border border-purple-400 dark:border-purple-600 rounded-xl p-6 shadow-md bg-purple-50 dark:bg-gray-800 flex flex-col justify-between">
          <div>
